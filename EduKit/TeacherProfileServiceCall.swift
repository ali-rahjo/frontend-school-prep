...
class TeacherProfileService {
    ...
    func getTeacherProfile(completion: @escaping (Result<[String: Any], Error>) -> Void) {
        
        guard let url = URL(string: "http://192.168.0.219:8000/api/v1/teacher/view/profile/") else {
            print("Invalid URL")
            return
        }
